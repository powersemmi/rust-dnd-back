...
pub fn App() -> impl IntoView {
    ...
    let is_scenes_open = RwSignal::new(false);
        ...
        match code.as_str() {
            "Escape" => {
                ...
                match active_window.get() {
                    ...
                    ActiveWindow::Scenes => is_scenes_open.set(false),
            ...
            "KeyG" => {
                is_scenes_open.set(true);
                active_window.set(ActiveWindow::Scenes);
            }
            "KeyS" => {
                ...
                AppState::Connected => view! {
                    <div style="width: 100%; height: 100%; position: relative;">
                        ...
                        <SideMenu
                            ...
                            on_scenes_open=Callback::new(move |_| {
                                is_scenes_open.set(true);
                                active_window.set(ActiveWindow::Scenes);
                            })
                        ...
                        // Окно сцен
                        <ScenesWindow
                            is_open=is_scenes_open
                            scenes=scenes
                            active_scene_id=active_scene_id
                            file_transfer=file_transfer.clone()
                            ws_sender=ws_sender
                            username=username
                            is_active=Signal::derive(move || active_window.get() == ActiveWindow::Scenes)
                            on_focus=Callback::new(move |_| active_window.set(ActiveWindow::Scenes))
                            theme=theme.get_value()
                        />
