use super::model::{StateEvent, StatisticsTab, compute_percentage};
use super::view_model::StatisticsViewModel;
    ...
    view! {
        ...
        >
            <div style="display: flex; flex-direction: column; height: 100%;">
                <TabBar tabs=tabs active_tab=vm.active_tab theme=theme.clone() />

                <div style="flex: 1; overflow-y: auto; padding: 0.25rem 1rem 3rem 1rem;">
                            ...
                            <div>
                                {move || {
                                    ...
                                    if results.is_empty() {
                                        ...
                                        view! {
                                            <For
                                                each=move || { voting_results.get().into_iter().collect::<Vec<_>>() }
                                                key=|(voting_id, _)| voting_id.clone()
                                                children=move |(_, result)| {
                                                    view! {
                                                        <div style=format!(
                                                            "padding: 0.75rem; background: {}; border-left: 0.1875rem solid {}; \
                                                             border-radius: 0.25rem; margin-bottom: 0.625rem;",
                                                            ...
                                                            <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                                                                <For
                                                                    ...
                                                                    children=move |opt_result| {
                                                                        let pct = compute_percentage(opt_result.count, result.total_voted);
                                                                            ...
                                                                            <div style=format!("background: {}; padding: 0.5rem; border-radius: 0.25rem;", theme.ui_bg_secondary)>
                                                                                <div style="display: flex; justify-content: space-between; margin-bottom: 0.375rem;">
                                                                                    ...
                                                                                    <span style=format!("color: {}; font-size: 0.8125rem; font-weight: bold;", theme.ui_button_primary)>
                                                                                        {format!("{} votes ({}%)", opt_result.count, pct)}
                                                                                    </span>
                                                                                </div>
                                                                                <div style=format!("width: 100%; height: 0.5rem; background: {}; border-radius: 0.25rem; overflow: hidden;", theme.ui_border)>
                                                                                    <div style=format!("height: 100%; background: {}; width: {}%;", theme.ui_button_primary, pct) />
                                                                                </div>
                                                                            </div>
                                                                        }
                                                                    }
                                        ...
                                        view! {
                                            <For
                                                ...
                                                children=move |event| {
                                                    view! {
                                                        <div style=format!(
                                                            "padding: 0.625rem; background: {}; border-left: 0.1875rem solid {}; \
                                                             border-radius: 0.25rem; margin-bottom: 0.625rem;",
